        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Approved and verified youth organizations • {uniqueOrgs.length} total
            </p>
          </div>
          {uniqueOrgs.length > 0 && (
            <Button
        ...
        {filteredOrgs.length === 0 ? (
          <Card>
            <CardContent className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold mb-2">No verified organizations</h3>
                          ...
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            ...
                            {(org as any).actionDate && (
                              <Badge variant="outline" className="text-xs">
                                Approved: {new Date((org as any).actionDate).toLocaleDateString()}
                              </Badge>
                            )}
                          </div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="font-medium">{org.memberCount.toLocaleString()}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="font-medium">{org.yearEstablished}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <Badge className={getRiskBadgeColor(org.riskAssessment.level)}>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="font-medium">{org.leadership?.length || 0}</p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="flex flex-col gap-2 lg:w-auto w-full">
                      ...
                      {(org as any).registrationNumber && (
                        <div className="text-sm text-muted-foreground mt-2">
                          <p className="font-medium">Reg. No: {(org as any).registrationNumber}</p>
            ...
            <CardContent className="pt-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center">
                  <p className="text-3xl font-bold text-green-700">{uniqueOrgs.length}</p>
                  <p className="text-sm text-green-600">Total Verified</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-green-700">
                    {uniqueOrgs.reduce((acc, org) => acc + org.memberCount, 0).toLocaleString()}
                  </p>
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-green-700">
                    {uniqueOrgs.filter(org => org.riskAssessment.level === 'low').length}
                  </p>
              ...
              {uniqueOrgs.length > 0 && (
                <div className="mt-4 pt-4 border-t border-green-200">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-green-700">Average Risk Score:</span>
                    <span className="font-bold text-green-800">
                      {Math.round(
                        uniqueOrgs.reduce((acc, org) => acc + org.riskAssessment.score, 0) / uniqueOrgs.length
                      )}
                    </span>
                  </div>
                </div>
