...
export async function testRead() {
    try {
        ...
        // Legacy keyFile approach (if you have a file locally)
        else if (process.env.GOOGLE_SERVICE_ACCOUNT_KEY) {
            console.log("Using keyFile approach");
            ...
            throw new Error("No Google authentication method found. Set GOOGLE_CREDENTIALS or GOOGLE_SERVICE_ACCOUNT_EMAIL/GOOGLE_PRIVATE_KEY");
        }
        ...
        const res = await sheets.spreadsheets.values.get({
            ...
            range: process.env.GOOGLE_SHEET_NAME, // Remove !A1:Z1000 - use just sheet name
        });
